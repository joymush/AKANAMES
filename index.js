...
function validate(){
   ...
   else if(document.myForm.date.value == "" || isNaN(document.myForm.month.value) || document.myForm.date.value.length !=2 ||document.myForm.date.value>31 || document.myForm.date.value <0){
       alert("please provide a valid date that you were born in");
       document.myForm.date.focus() ;
       return false;
   }
   else if(gender[0].checked==false && genders[1].checked==false){
...
case "female":
    if ( dayValue ==1){
        alert("you were born" + dayNames[0] + "and your akan name is" + femaleNames[0] + "!");   
    }
    else if(dayValue ==2){
        ...
        alert("you were born on" + dayNames[4] + "and your akan names is" + femaleNames[4] + "!");
    }
    else if(dayValue==6){
        alert("you were born on" + dayNames[5] + "and your akan name is" + femaleNames[5] + "!");
    }
    else if(dayValue==0){
        alert("you were born on" + dayNames[6] + "and your akan name is" + femaleNames[5] + "!");
    }
    break 
    default:
